...
function mekanik_desktop() {
	// (==================================== (Mekanik Navbar) Desktop Hover Dropdown Spesific Product ====================================)
	if (layar_DesktopResponsive > 768) {
		...
		// ------------- Beveragewares --------------------
		let onHover_Beveragewares = document.getElementById(
			"desk_hoverBeverageware"
		);
...
function dropdownFunction() {
	if (categories_dropdown.clientHeight === 0) {
		// Jika tinggi nol, atur tinggi ke tinggi scroll content
		categories_dropdown.style.height = categories_dropdown.scrollHeight + "px";
		categories_dropdown_temporary = categories_dropdown.scrollHeight;
	} else {
		// Jika tinggi bukan nol, atur tinggi ke nol
		categories_dropdown.style.height = 0;
...
function navbar_html_classlist() {
	...
	<nav class="navbar_container">
            ...
            <ul class="nav_menu">
                <li class="nav_item">
                    <a href="${takaware_Header}" class="nav_link">Home</a>
                </li>
                <li class="nav_item">
